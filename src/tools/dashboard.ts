...
export function registerDashboardTools(server: McpServer): void {
  server.tool(
    ...
    "Build a formatted dashboard: KPIs, data tables, charts, frozen header - all in one call. For custom layouts: sheets_build_sheet. For single tables: sheets_write_table.",
    {
