...
export function registerTableTools(server: McpServer): void {
  server.tool(
    "sheets_write_table",
    "Write a complete styled data table in one call: data + formulas + formatting + borders + freeze + column sizing. For building new tables. For editing existing tables, use individual tools.",
    {
